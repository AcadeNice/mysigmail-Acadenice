  ...
  <div class="max-w-4xl mx-auto px-4 py-8 relative">
    ...
    <div v-if="lang === 'fr'">
      ...
      <p class="text-sm text-muted-foreground mb-8">
        ...
        proposé par AcadéNice, ainsi que la manière dont vos données sont traitées. L’utilisation du
      ...
      <section class="mb-8">
        ...
        <p class="mb-2">
          Le service (ci-après le « Service ») permet aux utilisateurs de créer et de personnaliser
          une signature d’e-mail professionnelle, puis de la copier ou de l’intégrer dans certains
          clients de messagerie, notamment Gmail.
        </p>
        <p>
          Le Service est mis à disposition gratuitement par AcadéNice et est principalement destiné
          à un usage dans le cadre académique et professionnel des utilisateurs concernés.
        </p>
      </section>
      ...
      <section class="mb-8">
        ...
        <ul class="list-disc pl-5 space-y-1 mb-2">
          ...
          <li>
            ne sont utilisables que sur le poste et le navigateur où elles ont été configurées, sauf
            si vous les copiez ou exportez manuellement.
          </li>
        </ul>
        <p>
      ...
      <section class="mb-8">
        ...
        <ul class="list-disc pl-5 space-y-1">
          <li>
            l’exécution d’une mission d’intérêt public ou relevant de l’autorité publique confiée à
            AcadéNice&nbsp;;
          </li>
          <li>
      ...
      <section class="mb-8">
        ...
        <p class="mb-2">
          ...
          protéger les données traitées dans le cadre du Service (contrôle d’accès, journalisation,
          sauvegardes, etc.).
        </p>
        <p>
      ...
      <section class="mb-8">
        ...
        <p class="mb-2">
          ...
          <strong>MySigMail</strong>, disponible publiquement sur GitHub. Ce projet a été modifié et
          adapté afin de répondre aux besoins des utilisateurs francophones et au contexte
          d’AcadéNice.
        </p>
        <p class="mb-2">
        ...
        <p>
          ...
          cadre du présent projet AcadéNice ne fait pas l’objet d’une mise à disposition publique et
          ne peut être reproduit, diffusé ou réutilisé sans autorisation préalable d’AcadéNice, sauf
      ...
      <section class="mb-8">
        ...
        <ul class="list-disc pl-5 space-y-1 mt-1">
          ...
          <li>
            de tout dommage résultant d’une mauvaise configuration ou d’un contenu inapproprié de la
            signature ;
          </li>
          <li>
      ...
      <section class="mb-8">
        ...
        <p class="mb-2">
          Les présentes conditions et la présente politique de confidentialité peuvent être mises à
          jour pour tenir compte de l’évolution du Service ou du cadre légal.
        </p>
        <p>
          En cas de modification substantielle, une information pourra être affichée sur le Service.
      ...
      <section class="mb-4">
        ...
        <p>
          Pour toute question relative aux présentes conditions ou à la protection des données dans
          le cadre du Service, vous pouvez vous adresser à AcadéNice via les canaux de contact
          officiels.
        </p>
      </section>
    </div>
    ...
    <div v-else>
      ...
      <p class="text-sm text-muted-foreground mb-8">
        This page describes the rules for using the e-mail signature generation service provided by
        AcadéNice, as well as how your data is processed. By using the service, you agree to these
        terms.
      </p>
      ...
      <section class="mb-8">
        ...
        <p>
          The Service is provided free of charge by AcadéNice and is primarily intended for academic
          and professional use by the relevant users.
        </p>
      </section>
      ...
      <section class="mb-8">
        ...
        <p>
          Users agree to use the Service in compliance with applicable laws and regulations, as well
          as with AcadéNice’s internal rules.
        </p>
      </section>
      ...
      <section class="mb-8">
        ...
        <ul class="list-disc pl-5 space-y-1 mb-2">
          ...
          <li>
            ...
            <ul class="list-disc pl-5 mt-1 space-y-1">
              <li>
                to technical services or providers acting on our behalf (hosting, maintenance, etc.)
      ...
      <section class="mb-8">
        ...
        <p class="mb-2">
          The Service may offer integration with Gmail in order to synchronize the created signature
          with your Gmail account and update it via the Gmail API.
        </p>
        <ul class="list-disc pl-5 space-y-1 mb-2">
          <li>
          ...
          <li>
            Technical access tokens may be stored to allow your signature to be updated, solely for
            the purpose of providing the features described in the interface.
          </li>
          <li>
            We do not access the content of your e-mails or your address book beyond what is
            strictly necessary for signature management and within the limits of the permissions you
            have granted.
          </li>
          <li>
            You may revoke this authorisation at any time in your Google account settings and, where
            applicable, using the logout options provided in the Service.
          </li>
        </ul>
      </section>
      ...
      <section class="mb-8">
        ...
        <p class="mb-2">
          The processing of personal data carried out via the Service may be based in particular on:
        </p>
        <ul class="list-disc pl-5 space-y-1">
          <li>
      ...
      <section class="mb-8">
        ...
        <p>
          However, as no system is completely secure, users must also take all necessary precautions
          (locking their workstation, not disclosing their credentials, and so on).
        </p>
      </section>
      ...
      <section class="mb-8">
        ...
        <p>
          However, the specific code developed to adapt and integrate the Service within the present
          AcadéNice project is not made publicly available and may not be reproduced, distributed or
          reused without the prior authorisation of AcadéNice, unless explicitly stated otherwise.
        </p>
      </section>
      ...
      <section class="mb-8">
        ...
        <p class="mb-2">
          These terms and this privacy policy may be updated to reflect changes in the Service or in
          the legal framework.
        </p>
        <p>
      ...
      <section class="mb-4">
        ...
        <p>
          If you have any questions about these terms or about data protection in the context of the
          Service, you can contact AcadéNice via the academy’s official contact channels.
        </p>
      </section>
    </div>
  </div>
